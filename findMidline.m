...
%% Matt's new attempt on the eyes

% Redefine rotation matrix for local coord system with new points
%R = local_system([blob.xMid(2) blob.yMid(2)],[blob.xMid(1) blob.yMid(1)]);
...
%     hold on; plot(xOrigin,yOrigin,'ro',xRost,yRost,'go')
%     axs1 = gca;
% 
%     % plot eyes 
...
% 
%     % plot eyes
%     plot(axs2,blob.xEye,blob.yEye,'ow');
% % pause
% end
% 
% % EYE ORIENTATION -------
